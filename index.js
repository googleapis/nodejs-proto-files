...
module.exports.embedded_assistant = {
  v1alpha1: googleProtoFiles('assistant/embedded/v1alpha1/embedded_assistant.proto'),
  v1alpha2: googleProtoFiles('assistant/embedded/v1alpha2/embedded_assistant.proto')
};

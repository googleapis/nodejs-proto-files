...
describe('google-proto-files', () => {
  it('should export appengine', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.appengine.v1, resolve('appengine/v1/appengine.proto'));
  });
  it('should export bigtable', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.bigtable.v2, resolve('bigtable/v2/bigtable.proto'));
  });
  ...
  it('should export datastore', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.datastore.v1, resolve('datastore/v1/datastore.proto'));
    assert.strictEqual(
  ...
  it('should export dlp', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.dlp.v2beta1, resolve('privacy/dlp/v2beta1/dlp.proto'));
  });
  ...
  it('should export iam', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.iam.v1, resolve('iam/v1/iam_policy.proto'));
  });
  it('should export iam admin', () => {
    assert(googleProtoFiles.iam.admin);
    assert.strictEqual(
        googleProtoFiles.iam.admin.v1, resolve('iam/admin/v1/iam.proto'));
  });
  ...
  it('should export logging', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.logging.v2, resolve('logging/v2/logging.proto'));
  });
  ...
  it('should export pubsub', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.pubsub.v1, resolve('pubsub/v1/pubsub.proto'));
    assert.strictEqual(
  ...
  it('should export spanner', () => {
    ...
    assert.strictEqual(
        googleProtoFiles.spanner.v1, resolve('spanner/v1/spanner.proto'));
    assert.strictEqual(
